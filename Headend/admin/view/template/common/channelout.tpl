...
<body>	
	    ...
	    <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
				...
				<ul class="nav navbar-nav">
					...
					<li ><a href="<?php echo $ipout;?>">IP<span style="font-size:16px;" class="pull-right hidden-xs showopacity "></span></a></li>

					<li class="active"><a href="<?php echo $channelout;?>">CHANNELS<span style="font-size:16px;" class="pull-right hidden-xs showopacity "></span></a></li>
	...
	channels.forEach(function(eachChannel) {
		console.log(eachChannel['channelnumber'],eachChannel['output_channelname'],eachChannel['inputid'],eachChannel['targetid'],eachChannel['changed_ch_number'],eachChannel['changed_ch_name'],eachChannel['Qam_Freq'],eachChannel['rmx_no'],eachChannel['bitrate'])
